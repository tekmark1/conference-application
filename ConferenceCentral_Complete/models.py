...
class SessionForm(messages.Message):
    """SessionForm -- Session outboung form message"""
    name = messages.StringField(1)
    ...
    building = messages.StringField(10)
    websafeConferenceKey = messages.StringField(11)
    sponsor = messages.StringField(12)
...
class SessionForms(messages.Message):
    """SessionForms -- multiple SessionForm inbound session message"""
